            ...
            <form action="../siswa/proses.php" method="post">
                ...
                <input type="hidden" name="id" value="<?php echo $id; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="laki-Laki" aria-disabled="true">
                        </div>
                        </div>
                        ...
                        <input type="text" class="form-control" value="Perempuan" aria-disabled="true">
                        </div>
                        </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="jurusan" multiple class="form-control" id="exampleFormControlSelect2"  value="<?php echo $jurusan; ?>">
                            <option>TKRO</option>
                            <option>TBSM</option>
                            <option>RPL</option>
                            </select>
